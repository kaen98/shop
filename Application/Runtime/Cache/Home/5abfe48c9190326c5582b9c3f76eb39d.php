...
<head>
	...
	<link rel="stylesheet" href="<?php echo C('STYLE_URL');?>list.css" type="text/css">
			...
			<div class="newgoods leftbar mt10">
				...
				<div class="leftbar_wrap">
					<ul>
						<li>
							<dl>
								<dt><a href=""><img src="<?php echo C('IMAGES_URL');?>list_hot1.jpg" alt="" /></a></dt>
						...
						<li>
							<dl>
								<dt><a href=""><img src="<?php echo C('IMAGES_URL');?>list_hot2.jpg" alt="" /></a></dt>
						...
						<li class="last">
							<dl>
								<dt><a href=""><img src="<?php echo C('IMAGES_URL');?>list_hot3.jpg" alt="" /></a></dt>
		...
		<div class="list_bd fl ml10 mt10">
			...
			<div class="goodslist mt10">
				<ul>
					<li>
						<dl>
							<dt><a href=""><img src="<?php echo C('IMAGES_URL');?>goods1.jpg" alt="" /></a></dt>
					...
					<li>
						<dl>
							<dt><a href=""><img src="<?php echo C('IMAGES_URL');?>goods2.jpg" alt="" /></a></dt>
					...
					<li>
						<dl>
							<dt><a href=""><img src="<?php echo C('IMAGES_URL');?>goods3.jpg" alt="" /></a></dt>
					...
					<li>
						<dl>
							<dt><a href=""><img src="<?php echo C('IMAGES_URL');?>goods4.jpg" alt="" /></a></dt>
					...
					<li>
						<dl>
							<dt><a href=""><img src="<?php echo C('IMAGES_URL');?>goods5.jpg" alt="" /></a></dt>
					...
					<li>
						<dl>
							<dt><a href=""><img src="<?php echo C('IMAGES_URL');?>goods6.jpg" alt="" /></a></dt>
