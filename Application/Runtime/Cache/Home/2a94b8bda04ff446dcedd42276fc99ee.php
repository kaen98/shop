...
<head>
	...
	<title>京西商城</title>
	<link rel="stylesheet" href="<?php echo C('STYLE_URL');?>base.css" type="text/css">
	<link rel="stylesheet" href="<?php echo C('STYLE_URL');?>global.css" type="text/css">
	<link rel="stylesheet" href="<?php echo C('STYLE_URL');?>header.css" type="text/css">
	<link rel="stylesheet" href="<?php echo C('STYLE_URL');?>index.css" type="text/css">
	<link rel="stylesheet" href="<?php echo C('STYLE_URL');?>bottomnav.css" type="text/css">
	<link rel="stylesheet" href="<?php echo C('STYLE_URL');?>footer.css" type="text/css">
...
<body>
	...
	<div class="header w1210 bc mt15">
		...
		<div class="logo w1210">
			<h1 class="fl"><a href="index.html"><img src="<?php echo C('IMAGES_URL');?>logo.png" alt="京西商城"></a></h1>
			<!-- 头部搜索 start -->
			<div class="search fl">
				...
				<dl>
					...
					<dd>
						...
						<div class="viewlist mt10">
							<h3>最近浏览的商品：</h3>
							<ul>
								<li><a href=""><img src="<?php echo C('IMAGES_URL');?>view_list1.jpg" alt="" /></a></li>
								<li><a href=""><img src="<?php echo C('IMAGES_URL');?>view_list2.jpg" alt="" /></a></li>
								<li><a href=""><img src="<?php echo C('IMAGES_URL');?>view_list3.jpg" alt="" /></a></li>
							</ul>
						</div>
					</dd>
				</dl>
	...
	<div class="colligate w1210 bc mt10">
		...
		<div class="slide fl">
			<div class="area">
				<div class="slide_items">
					<ul>
						<li><a href=""><img src="<?php echo C('IMAGES_URL');?>index_slide1.jpg" alt="" /></a></li>
						<li><a href=""><img src="<?php echo C('IMAGES_URL');?>index_slide2.jpg" alt="" /></a></li>
						<li><a href=""><img src="<?php echo C('IMAGES_URL');?>index_slide3.jpg" alt="" /></a></li>
						<li><a href=""><img src="<?php echo C('IMAGES_URL');?>index_slide4.jpg" alt="" /></a></li>
						<li><a href=""><img src="<?php echo C('IMAGES_URL');?>index_slide5.jpg" alt="" /></a></li>
						<li><a href=""><img src="<?php echo C('IMAGES_URL');?>index_slide6.jpg" alt="" /></a></li>
					</ul>
				</div>
		...
		<div class="coll_right fl ml10">
			<div class="ad"><a href=""><img src="<?php echo C('IMAGES_URL');?>ad.jpg" alt="" /></a></div>
			...
			<div class="service mt10">
				...
				<div class="service_wrap">
					...
					<div class="travel none">
						<ul>
							<li>
								<a href=""><img src="<?php echo C('IMAGES_URL');?>holiday.jpg" alt="" /></a>
								<a href="" class="button">度假查询</a>
							</li>
							<li>
								<a href=""><img src="<?php echo C('IMAGES_URL');?>scenic.jpg" alt="" /></a>
					...
					<div class="lottery none">
						<p><img src="<?php echo C('IMAGES_URL');?>lottery.jpg" alt="" /></p>
					</div>
					<!-- 彩票 end -->
					...
					<div class="game none">
						<ul>
							<li><a href=""><img src="<?php echo C('IMAGES_URL');?>sanguo.jpg" alt="" /></a></li>
							<li><a href=""><img src="<?php echo C('IMAGES_URL');?>taohua.jpg" alt="" /></a></li>
							<li><a href=""><img src="<?php echo C('IMAGES_URL');?>wulin.jpg" alt="" /></a></li>
						</ul>
					</div>
					<!-- 游戏 end -->
				</div>
	...
	<div class="guide w1210 bc mt15">
			...
			<div class="guide_wrap">
				...
				<div class="crazy">
					<ul>
						<li>
							<dl>
								<dt><a href=""><img src="<?php echo C('IMAGES_URL');?>crazy1.jpg" alt="" /></a></dt>
						...
						<li>
							<dl>
								<dt><a href=""><img src="<?php echo C('IMAGES_URL');?>crazy2.jpg" alt="" /></a></dt>
						...
						<li>
							<dl>
								<dt><a href=""><img src="<?php echo C('IMAGES_URL');?>crazy3.jpg" alt="" /></a></dt>
						...
						<li>
							<dl>
								<dt><a href=""><img src="<?php echo C('IMAGES_URL');?>crazy4.jpg" alt="" /></a></dt>
						...
						<li>
							<dl>
								<dt><a href=""><img src="<?php echo C('IMAGES_URL');?>crazy5.jpg" alt="" /></a></dt>
				...
				<div class="hot none">
					<ul>
						<li>
							<dl>
								<dt><a href=""><img src="<?php echo C('IMAGES_URL');?>hot1.jpg" alt="" /></a></dt>
						...
						<li>
							<dl>
								<dt><a href=""><img src="<?php echo C('IMAGES_URL');?>hot2.jpg" alt="" /></a></dt>
						...
						<li>
							<dl>
								<dt><a href=""><img src="<?php echo C('IMAGES_URL');?>hot3.jpg" alt="" /></a></dt>
				...
				<div class="recommend none">
					<ul>
						<li>
							<dl>
								<dt><a href=""><img src="<?php echo C('IMAGES_URL');?>recommend1.jpg" alt="" /></a></dt>
						...
						<li>
							<dl>
								<dt><a href=""><img src="<?php echo C('IMAGES_URL');?>recommend2.jpg" alt="" /></a></dt>
						...
						<li>
							<dl>
								<dt><a href=""><img src="<?php echo C('IMAGES_URL');?>recommend3.jpg" alt="" /></a></dt>
				...
				<div class="new none">
					<ul>
						<li>
							<dl>
								<dt><a href=""><img src="<?php echo C('IMAGES_URL');?>new1.jpg" alt="" /></a></dt>
						...
						<li>
							<dl>
								<dt><a href=""><img src="<?php echo C('IMAGES_URL');?>new2.jpg" alt="" /></a></dt>
						...
						<li>
							<dl>
								<dt><a href=""><img src="<?php echo C('IMAGES_URL');?>new3.jpg" alt="" /></a></dt>
				...
				<div class="guess none">
					<ul>
						<li>
							<dl>
								<dt><a href=""><img src="<?php echo C('IMAGES_URL');?>guess1.jpg" alt="" /></a></dt>
						...
						<li>
							<dl>
								<dt><a href=""><img src="<?php echo C('IMAGES_URL');?>guess2.jpg" alt="" /></a></dt>
						...
						<li>
							<dl>
								<dt><a href=""><img src="<?php echo C('IMAGES_URL');?>guess3.jpg" alt="" /></a></dt>
		...
		<div class="sidebar fl ml10">
			...
			<div class="sidebar_wrap">
				<dl class="first">
					<dt class="fl"><a href=""><img src="<?php echo C('IMAGES_URL');?>viewsonic.jpg" alt="" /></a></dt>
				...
				<dl>
					<dt class="fr"><a href=""><img src="<?php echo C('IMAGES_URL');?>samsung.jpg" alt="" /></a></dt>
	...
	<div class="floor1 floor w1210 bc mt10">
		...
		<div class="floor_left fl">
			...
			<div class="cate fl">
				...
				<div class="cate_wrap">
					...
					<p><a href=""><img src="<?php echo C('IMAGES_URL');?>notebook.jpg" alt="" /></a></p>
				</div>
				...
				<div class="goodslist_wrap">
					<div>
						<ul>
							<li>
								<dl>
									<dt><a href=""><img src="<?php echo C('IMAGES_URL');?>hpG4.jpg" alt="" /></a></dt>
							...
							<li>
								<dl>
									<dt><a href=""><img src="<?php echo C('IMAGES_URL');?>thinkpad e420.jpg" alt="" /></a></dt>
							...
							<li>
								<dl>
									<dt><a href=""><img src="<?php echo C('IMAGES_URL');?>acer4739.jpg" alt="" /></a></dt>
							...
							<li>
								<dl>
									<dt><a href=""><img src="<?php echo C('IMAGES_URL');?>samsung6800.jpg" alt="" /></a></dt>
							...
							<li>
								<dl>
									<dt><a href=""><img src="<?php echo C('IMAGES_URL');?>lh531.jpg" alt="" /></a></dt>
							...
							<li>
								<dl>
									<dt><a href=""><img src="<?php echo C('IMAGES_URL');?>qinghuax2.jpg" alt="" /></a></dt>
		...
		<div class="sidebar fl ml10">
			...
			<div class="brand">
				...
				<div class="sidebar_wrap">
					<ul>
						<li><a href=""><img src="<?php echo C('IMAGES_URL');?>dell.gif" alt="" /></a></li>
						<li><a href=""><img src="<?php echo C('IMAGES_URL');?>acer.gif" alt="" /></a></li>
						<li><a href=""><img src="<?php echo C('IMAGES_URL');?>fujitsu.jpg" alt="" /></a></li>
						<li><a href=""><img src="<?php echo C('IMAGES_URL');?>hp.jpg" alt="" /></a></li>
						<li><a href=""><img src="<?php echo C('IMAGES_URL');?>lenove.jpg" alt="" /></a></li>
						<li><a href=""><img src="<?php echo C('IMAGES_URL');?>samsung.gif" alt="" /></a></li>
						<li><a href=""><img src="<?php echo C('IMAGES_URL');?>dlink.gif" alt="" /></a></li>
						<li><a href=""><img src="<?php echo C('IMAGES_URL');?>seagate.jpg" alt="" /></a></li>
						<li><a href=""><img src="<?php echo C('IMAGES_URL');?>intel.jpg" alt="" /></a></li>
					</ul>
				</div>
			</div>
			<!-- 品牌旗舰店 end -->
			...
			<!-- 广告 start -->
			<div class="ads mt10">
				<a href=""><img src="<?php echo C('IMAGES_URL');?>canon.jpg" alt="" /></a>
			</div>
			<!-- 广告 end -->
		</div>
		<!-- 右侧 end -->
	...
	<div class="footer w1210 bc mt10">
		...
		<p class="auth">
			<a href=""><img src="<?php echo C('IMAGES_URL');?>xin.png" alt="" /></a>
			<a href=""><img src="<?php echo C('IMAGES_URL');?>kexin.jpg" alt="" /></a>
			<a href=""><img src="<?php echo C('IMAGES_URL');?>police.jpg" alt="" /></a>
			<a href=""><img src="<?php echo C('IMAGES_URL');?>beian.gif" alt="" /></a>
		</p>
	</div>
	<!-- 底部版权 end -->
